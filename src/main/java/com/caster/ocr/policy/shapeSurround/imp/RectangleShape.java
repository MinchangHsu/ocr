 ...
 */
public class RectangleShape extends AbsShapeProcess {

    public RectangleShape() {
    }

    public RectangleShape(Map<String, int[]> pointsRGBInfoMap, Map<String, int[]> originRGBInfoMap, int x, int y, int step) {
    ...
    public AbsShapeProcess init(Map<String, int[]> pointsRGBInfoMap, Map<String, int[]> originRGBInfoMap, int x, int y, int step){
        return new RectangleShape(pointsRGBInfoMap,originRGBInfoMap,x,y,step);
    }
